...
def run(context):
    ...
    try:
        ...
        angleValue2 = (360 / sides) * (percent / 100)
        ...
        extInput = extrudes.createInput( prof_kresling_1 , adsk.fusion.FeatureOperations.NewBodyFeatureOperation )

        distance = adsk.core.ValueInput.createByReal(0.05)
        extInput.setDistanceExtent( True , distance )
        extInput.isSolid = True
        extrude_kresling_1 = extrudes.add( extInput )
        ...
        #create an extrusion input
        extInput = extrudes.createInput( prof_kresling_2 , adsk.fusion.FeatureOperations.NewBodyFeatureOperation )

        extInput.setDistanceExtent( True , distance )
        extInput.isSolid = True
        extrude_kresling_2 = extrudes.add( extInput )
        ...
        # bodies.add(rootComp.bRepBodies.item(0))  # Add the extruded body to be mirrored
        # bodies.add(rootComp.bRepBodies.item(1))  # Add the extruded body to be mirrored

        mirrorInput = mirrorFeats.createInput(bodies, offsetPlane )
        mirrorFeats.add(mirrorInput)

        # repetition in the the top direction : 
        ...
        inputEntites = adsk.core.ObjectCollection.create()
        # inputEntites.add(rootComp.bRepBodies.item(0))
        # inputEntites.add(rootComp.bRepBodies.item(1))
        # inputEntites.add(rootComp.bRepBodies.item(2))
        ...
        offset = adsk.core.ValueInput.createByString("-5 cm")
        ...
        sketchCirclesObj3.addByCenterRadius( sketch3.originPoint, 5.0)
        ...
        bodies = rootComp.bRepBodies.item(102)
        ...
        bodies.add(rootComp.bRepBodies.item(103))  # Add the extruded body to be mirrored
        # bodies.add(rootComp.bRepBodies.item(1))  # Add the extruded body to be mirrored
