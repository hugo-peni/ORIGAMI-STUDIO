...
npp = numel(indp) ;
n = 5 ; 
Load = [ indp , 0*ones(npp,1) , 0*ones(npp,1) , -n*ones(npp,1) ; ] ;
...
%VisualFold_3(U_his(:,1:interv:endicrm),truss,angles , 0.00001 , LF_his )
VisualFold_4(U_his(:,1:interv:endicrm),truss,angles,0.0001,LF_his,instdof,[-inf inf -inf inf])
